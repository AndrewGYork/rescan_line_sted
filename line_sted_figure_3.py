...
"""
def main():
    for output_dir in ('Figure_3_output',
                       os.path.join('Figure_3_output', '1_gif_figs'),
                       os.path.join('Figure_3_output', '2_mp4_figs')):
...
def animate(input_filenames, output_filename):
    ...
    output_filename_gif = os.path.join(
        os.getcwd(), 'Figure_3_output', '1_gif_figs', output_filename+'.gif')
    output_filename_mp4 = os.path.join(
        os.getcwd(), 'Figure_3_output', '2_mp4_figs', output_filename+'.mp4')
